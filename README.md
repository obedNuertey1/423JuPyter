...
Technologies
    <p align="center">
        ...
        <img src="https://skillicons.dev/icons?i=ps,ai,pr,c,cpp,cs,ts,discord,twitter,mongodb,mysql,postgresql,instagram,idea,git,wordpress,devto,figma,github,githubactions,gitlab,laravel,linux,postman,powershell,java,prisma,rocket,py,pytorch,qt,r,rabbitmq,rails,raspberrypi,react,reactivex,redis,redux&perline=13"/><br>
        <!-- gif -->
